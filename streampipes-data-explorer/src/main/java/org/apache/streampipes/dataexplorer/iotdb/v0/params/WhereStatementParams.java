 ...
 *
 */
package org.apache.streampipes.dataexplorer.iotdb.v0.params;
...
public class WhereStatementParams extends IotdbQueryParams {
  ...
  private WhereCondition buildTimeBoundary(Long time, String operator) {
    return new WhereCondition("time", operator, String.valueOf(time));
  }
