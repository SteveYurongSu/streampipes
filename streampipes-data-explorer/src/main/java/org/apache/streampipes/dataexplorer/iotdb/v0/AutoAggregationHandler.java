 ...
 *
 */
package org.apache.streampipes.dataexplorer.iotdb.v0;

import org.apache.streampipes.dataexplorer.DataLakeIotdbManagement;
import org.apache.streampipes.dataexplorer.iotdb.v0.params.SelectColumn;
...
import static org.apache.streampipes.dataexplorer.iotdb.v0.SupportedDataLakeQueryParameters.*;
...
public class AutoAggregationHandler {
  ...
  private final DataLakeIotdbManagement dataLakeManagement;
  ...
  public Integer getCount(String fieldName) {
    ...
    SpQueryResult result = new DataLakeIotdbManagement().getData(countParams, true);
