...
public class DataLakeManagementUtils {
  ...
  public static Map<String, IotdbQueryParams> getSelectQueryParams(ProvidedQueryParams params) {
    Map<String, IotdbQueryParams> queryParts = new HashMap<>();
  ...
  public static Map<String, IotdbQueryParams> getDeleteQueryParams(String measurementID,
                                                                   Long startDate,
                                                                   Long endDate) {
    Map<String, IotdbQueryParams> queryParts = new HashMap<>();
