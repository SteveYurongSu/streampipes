...
public enum Envs {
  ...
  SP_TS_TYPE("SP_TS_TYPE","iotdb"),

  SP_TS_STORAGE_BUCKET("SP_TS_STORAGE_BUCKET", "sp"),

  // iotdb
  SP_TS_IOTDB_STORAGE_HOST("SP_TS_IOTDB_STORAGE_HOST", "127.0.0.1", DefaultEnvValues.LOCALHOST),
  SP_TS_IOTDB_STORAGE_PORT("SP_TS_IOTDB_STORAGE_PORT", "6667"),

  SP_TS_IOTDB_STORAGE_BUCKET("SP_TS_IOTDB_STORAGE_BUCKET", "root.sp.dataLake"),
  SP_TS_IOTDB_STORAGE_USERNAME("SP_TS_IOTDB_STORAGE_USERNAME", "root"),
  SP_TS_IOTDB_STORAGE_PASSWORD("SP_TS_IOTDB_STORAGE_PASSWORD", "root");
